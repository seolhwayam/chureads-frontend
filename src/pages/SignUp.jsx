    ...
    <div className="h-full flex flex-col justify-center">
      <div className="text-center px-6">
        ...
        <form id="login-form" className="text-center flex flex-col gap-2" onSubmit={handleSignUp}>
          <InputField type="text" field="name" value={name} onChange={handleInputChange}/>
          <InputField type="text" field="email" value={email} onChange={handleInputChange}/>
          <InputField type="password" value={password} field="password" onChange={handleInputChange}/>
